...
precompile(Tuple{typeof(Base.CoreLogging.shouldlog), Logging.ConsoleLogger, Base.CoreLogging.LogLevel, Module, Symbol, Symbol})
precompile(Tuple{Type{NamedTuple{(:state, :county, :cases, :deaths, :pop), T} where T<:Tuple}, Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}}})
...
precompile(Tuple{getfield(DataFrames, Symbol("##DataFrame#104")), Base.Iterators.Pairs{Symbol, Array{Any, 1}, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:state, :county, :cases, :deaths, :pop), Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}}}}, Type{DataFrames.DataFrame}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:state, :county, :cases, :deaths, :pop), Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}}}, Type{DataFrames.DataFrame}})
...
precompile(Tuple{getfield(Main, Symbol("#3#4"))})
...
precompile(Tuple{typeof(Base.vect), String})
precompile(Tuple{Type{NamedTuple{(:external_stylesheets,), T} where T<:Tuple}, Tuple{Array{String, 1}}})
...
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Int64, Int64}}})
...
precompile(Tuple{getfield(Dashboards, Symbol("##dcc_interval#15")), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol}, NamedTuple{(:id, :interval, :max_intervals), Tuple{String, Int64, Int64}}}, typeof(Dashboards.dcc_interval)})
...
precompile(Tuple{getfield(Dashboards, Symbol("##html_div#50")), Base.Iterators.Pairs{Symbol, String, Tuple{Symbol}, NamedTuple{(:id,), Tuple{String}}}, typeof(Dashboards.html_div), Dashboards.Components.Component})
...
precompile(Tuple{getfield(Dashboards, Symbol("##dcc_dropdown#4")), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol}, NamedTuple{(:id, :options), Tuple{String, Array{Any, 1}}}}, typeof(Dashboards.dcc_dropdown)})
...
precompile(Tuple{getfield(Main, Symbol("#16#18")), Int64})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Dashboards.Components.Component, 1}, Dashboards.Components.Component, Base.Generator{Base.UnitRange{Int64}, getfield(Main, Symbol("#16#18"))}, Int64})
...
precompile(Tuple{getfield(Main, Symbol("#15#17"))})
...
precompile(Tuple{getfield(Dashboards, Symbol("##Dash#605")), Array{String, 1}, Array{String, 1}, String, String, Type{Dashboards.Dash}, getfield(Main, Symbol("#15#17")), String})
...
precompile(Tuple{typeof(Base.vect), Tuple{Symbol, Symbol}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#21#24")), Base.UnitRange{Int64}})
precompile(Tuple{typeof(Base.collect_to!), Array{Tuple{Symbol, Symbol}, 1}, Base.Generator{Base.UnitRange{Int64}, getfield(Main, Symbol("#21#24"))}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.UnitRange{Int64}, getfield(Main, Symbol("#21#24"))}})
precompile(Tuple{typeof(Base.allocatedinline), Type{Tuple{Symbol, Symbol}}})
precompile(Tuple{typeof(Base.vcat), Array{Tuple{Symbol, Symbol}, 1}, Tuple{Symbol, Symbol}, Tuple{Symbol, Symbol}})
precompile(Tuple{typeof(Base.throw_boundserror), Array{Tuple{Symbol, Symbol}, 1}, Tuple{Base.UnitRange{Int64}}})
precompile(Tuple{typeof(Base.__cat), Array{Tuple{Symbol, Symbol}, 1}, Tuple{Int64}, Tuple{Bool}, Array{Tuple{Symbol, Symbol}, 1}, Vararg{Any, N} where N})
...
precompile(Tuple{Type{Dashboards.CallbackId}, Array{Any, 1}, Array{Tuple{Symbol, Symbol}, 1}, Array{Tuple{Symbol, Symbol}, 1}})
...
precompile(Tuple{typeof(Dashboards.callback!), Function, Dashboards.Dash, Dashboards.CallbackId})
...
precompile(Tuple{typeof(Base.string), Symbol, String, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#28#29")), Base.UnitRange{Int64}})
precompile(Tuple{Type{Base.Iterators.Flatten{I} where I}, Base.Generator{Base.UnitRange{Int64}, getfield(Main, Symbol("#28#29"))}})
precompile(Tuple{typeof(Base.grow_to!), Array{Tuple{Symbol, Symbol}, 1}, Base.Iterators.Flatten{Base.Generator{Base.UnitRange{Int64}, getfield(Main, Symbol("#28#29"))}}, Tuple{Int64, Base.Generator{Tuple{Symbol, Symbol}, getfield(Main, Symbol("#27#30")){Int64}}, Int64}})
precompile(Tuple{typeof(Base.grow_to!), Array{Tuple{Symbol, Symbol}, 1}, Base.Iterators.Flatten{Base.Generator{Base.UnitRange{Int64}, getfield(Main, Symbol("#28#29"))}}})
precompile(Tuple{typeof(Base.collect), Base.Iterators.Flatten{Base.Generator{Base.UnitRange{Int64}, getfield(Main, Symbol("#28#29"))}}})
precompile(Tuple{typeof(Base.vcat), Tuple{Symbol, Symbol}, Tuple{Symbol, Symbol}, Tuple{Symbol, Symbol}, Vararg{Any, N} where N})
precompile(Tuple{getfield(Base, Symbol("#cat##kw")), NamedTuple{(:dims,), Tuple{Base.Val{1}}}, typeof(Base.cat), Tuple{Symbol, Symbol}, Vararg{Any, N} where N})
precompile(Tuple{getfield(Base, Symbol("##cat#110")), Base.Val{1}, typeof(Base.cat), Tuple{Symbol, Symbol}, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base._cat), Base.Val{1}, Tuple{Symbol, Symbol}, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.promote_eltypeof), Tuple{Symbol, Symbol}, Tuple{Symbol, Symbol}, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.promote_eltypeof), Tuple{Symbol, Symbol}, Array{Tuple{Symbol, Symbol}, 1}})
...
precompile(Tuple{typeof(Base._cat_t), Base.Val{1}, Type, Tuple{Symbol, Symbol}, Vararg{Any, N} where N})
...
precompile(Tuple{getfield(Dashboards, Symbol("#@callid_str")), LineNumberNode, Module, Any})
precompile(Tuple{typeof(Base.match), Base.Regex, String})
precompile(Tuple{typeof(Base.getindex), Base.RegexMatch, Symbol})
precompile(Tuple{getfield(Dashboards, Symbol("#make_prop#607")), Base.SubString{String}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Tuple{Symbol, Symbol}, 1}, Tuple{Symbol, Symbol}, Base.Generator{Array{Base.SubString{String}, 1}, getfield(Dashboards, Symbol("#606#608")){getfield(Dashboards, Symbol("#make_prop#607"))}}, Int64})
precompile(Tuple{typeof(Base._collect), Array{Base.SubString{String}, 1}, Base.Generator{Array{Base.SubString{String}, 1}, getfield(Dashboards, Symbol("#606#608")){getfield(Dashboards, Symbol("#make_prop#607"))}}, Base.EltypeUnknown, Base.HasShape{1}})
precompile(Tuple{typeof(Dashboards.parse_props), Base.SubString{String}})
precompile(Tuple{Type{Array{Tuple{Symbol, Symbol}, 1}}})
precompile(Tuple{Type{Dashboards.CallbackId}, Array{Tuple{Symbol, Symbol}, 1}, Array{Tuple{Symbol, Symbol}, 1}, Array{Tuple{Symbol, Symbol}, 1}})
...
precompile(Tuple{typeof(Base.similar), Array{typeof(Base.string), 1}, Type{T} where T})
precompile(Tuple{typeof(Base.firstindex), Array{Function, 1}})
...
precompile(Tuple{getfield(Main, Symbol("#25#26")), Nothing})
...
precompile(Tuple{getfield(Main, Symbol("#31#32")), String})
...
precompile(Tuple{getfield(Main, Symbol("#33#34")), Bool})
...
precompile(Tuple{typeof(Base.fill!), Array{Array{Any, 1}, 1}, Array{Any, 1}})
...
precompile(Tuple{getfield(Main, Symbol("#19#22")), Nothing})
precompile(Tuple{typeof(Base.sort!), Array{String, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#20#23")), Array{String, 1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, NamedTuple{(:label, :value), Tuple{String, String}}, Base.Generator{Array{String, 1}, getfield(Main, Symbol("#20#23"))}, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{String, 1}, getfield(Main, Symbol("#20#23"))}})
precompile(Tuple{typeof(Base.fill!), Array{Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, 1}, Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}})
precompile(Tuple{typeof(Base.fill), Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, Int64})
...
precompile(Tuple{typeof(Base.vcat), Array{Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, 1}, Dashboards.Components.Component, Int64})
precompile(Tuple{typeof(Base.__cat), Array{Any, 1}, Tuple{Int64}, Tuple{Bool}, Array{Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, 1}, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.cat_indices), Array{Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, 1}, Int64})
precompile(Tuple{typeof(Base.cat_size), Array{Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, 1}, Int64})
precompile(Tuple{typeof(Base.throw_setindex_mismatch), Array{Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, 1}, Tuple{Int64}})
precompile(Tuple{typeof(Base.setindex!), Array{Any, 1}, Array{Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, 1}, Base.UnitRange{Int64}})
...
precompile(Tuple{typeof(Base.fill!), Base.SubArray{Any, 1, Array{Any, 1}, Tuple{Base.UnitRange{Int64}}, true}, Dashboards.Components.Component})
precompile(Tuple{typeof(Base.fill!), Base.SubArray{Any, 1, Array{Any, 1}, Tuple{Base.UnitRange{Int64}}, true}, Int64})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Any}, Base.Dict{Symbol, Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}}, Symbol})
precompile(Tuple{typeof(Base.push!), Base.Dict{Symbol, Any}, Base.Pair{Symbol, Base.Dict{Symbol, Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}}}})
precompile(Tuple{Type{Base.Dict{K, V} where V where K}, Base.Pair{Symbol, Dashboards.Components.Component}})
precompile(Tuple{Type{Base.Pair{A, B} where B where A}, Symbol, Base.Dict{Symbol, Dashboards.Components.Component}})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Any}, Base.Dict{Symbol, Dashboards.Components.Component}, Symbol})
precompile(Tuple{typeof(Base.push!), Base.Dict{Symbol, Any}, Base.Pair{Symbol, Base.Dict{Symbol, Dashboards.Components.Component}}})
...
precompile(Tuple{typeof(Base.push!), Base.Dict{Symbol, Any}, Base.Pair{Symbol, Base.Dict{Symbol, Int64}}})
precompile(Tuple{Type{Base.Dict{Symbol, Base.Dict{Symbol, Any}}}})
precompile(Tuple{typeof(Base.empty), Base.Dict{Any, Any}, Type{Symbol}, Type{Base.Dict{Symbol, Any}}})
...
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Base.Dict{Symbol, Any}}, Base.Dict{Symbol, Any}, Bool})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Base.Dict{Symbol, Any}}, Base.Dict{Symbol, Any}, Base.Dict{Symbol, Any}})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Base.Dict{Symbol, Any}}, Tuple{Base.Pair{Symbol, Base.Dict{Symbol, Any}}, Base.Pair{Symbol, Bool}}, Int64})
precompile(Tuple{typeof(Base.empty), Base.Dict{Symbol, Base.Dict{Symbol, Any}}, Type{Symbol}, Type{Any}})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Any}, Base.Dict{Symbol, Any}, Symbol})
precompile(Tuple{typeof(Base.merge!), Base.Dict{Symbol, Any}, Base.Dict{Symbol, Base.Dict{Symbol, Any}}})
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Any}, Tuple{Base.Pair{Symbol, Base.Dict{Symbol, Any}}, Base.Pair{Symbol, Bool}}, Int64})
...
precompile(Tuple{typeof(Base.convert), Type{Any}, Base.Dict{Symbol, Dashboards.Components.Component}})
precompile(Tuple{getfield(JSON2, Symbol("##write#6")), Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(JSON2.write), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.Dict{Symbol, Dashboards.Components.Component}})
precompile(Tuple{typeof(JSON2.write), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.Dict{Symbol, Dashboards.Components.Component}})
...
precompile(Tuple{typeof(Base.convert), Type{Any}, Base.Dict{Symbol, Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}}})
precompile(Tuple{getfield(JSON2, Symbol("##write#6")), Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(JSON2.write), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.Dict{Symbol, Int64}})
precompile(Tuple{typeof(JSON2.write), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.Dict{Symbol, Int64}})
...
precompile(Tuple{typeof(Base._similar_for), Array{Any, 1}, Type{Int64}, Base.Generator{Array{Any, 1}, getfield(Dashboards, Symbol("#626#628")){Dashboards.Dash}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to!), Array{Int64, 1}, Base.Generator{Array{Any, 1}, getfield(Dashboards, Symbol("#626#628")){Dashboards.Dash}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Int64, 1}, Int64, Base.Generator{Array{Any, 1}, getfield(Dashboards, Symbol("#626#628")){Dashboards.Dash}}, Int64})
precompile(Tuple{typeof(Base.append!), Array{Any, 1}, Array{Int64, 1}})
precompile(Tuple{getfield(Main, Symbol("#19#22")), Int64})
precompile(Tuple{getfield(Main, Symbol("#35#36")), String})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#13#14")){String, Bool}, Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{getfield(Main, Symbol("#13#14")){String, Bool}, Array{Nothing, 1}})
precompile(Tuple{typeof(Base.collect_to!), Array{DataFrames.DataFrame, 1}, Base.Generator{Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}})
precompile(Tuple{Type{NamedTuple{(:type, :alignment, :roll, :popnorm), T} where T<:Tuple}, Tuple{Symbol, Int64, Int64, Bool}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Symbol, Int64, Int64, Bool}}})
...
precompile(Tuple{Type{NamedTuple{(:xaxis_title, :yaxis_title, :xaxis, :yaxis_ticksuffix, :hovermode, :title, :height, :yaxis_type), T} where T<:Tuple}, Tuple{String, String, Base.Dict{Any, Any}, String, String, String, String, String}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, String, Base.Dict{Any, Any}, String, String, String, String, String}}})
precompile(Tuple{getfield(PlotlyBase, Symbol("#7#9")){PlotlyBase.Layout{Base.Dict{Symbol, Any}}}, Base.Pair{Symbol, Any}})
precompile(Tuple{getfield(PlotlyBase, Symbol("#_#6#8")), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:xaxis_title, :yaxis_title, :xaxis, :yaxis_ticksuffix, :hovermode, :title, :height, :yaxis_type), Tuple{String, String, Base.Dict{Any, Any}, String, String, String, String, String}}}, Type{PlotlyBase.Layout{Base.Dict{Symbol, Any}}}, Base.Dict{Symbol, Any}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:xaxis_title, :yaxis_title, :xaxis, :yaxis_ticksuffix, :hovermode, :title, :height, :yaxis_type), Tuple{String, String, Base.Dict{Any, Any}, String, String, String, String, String}}, Type{PlotlyBase.Layout{T} where T<:Base.AbstractDict{Symbol, Any}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#11#12")), Array{String, 1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}, NamedTuple{(:label, :value), Tuple{String, String}}, Base.Generator{Array{String, 1}, getfield(Main, Symbol("#11#12"))}, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{String, 1}, getfield(Main, Symbol("#11#12"))}})
precompile(Tuple{getfield(Main, Symbol("#25#26")), String})
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Nothing, 1}, String, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{Union{Nothing, String}, 1}, Base.Generator{Array{Any, 1}, getfield(Dashboards, Symbol("#626#628")){Dashboards.Dash}}, Int64, Int64})
precompile(Tuple{typeof(Base.copyto!), Array{Any, 1}, Int64, Array{Union{Nothing, String}, 1}, Int64, Int64})
precompile(Tuple{typeof(Base.append!), Array{Any, 1}, Array{Union{Nothing, String}, 1}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#13#14")){String, Bool}, Base.Iterators.PartitionIterator{Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.PartitionIterator{Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._array_for), Type{DataFrames.DataFrame}, Base.Iterators.PartitionIterator{Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, Base.HasLength})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.PartitionIterator{Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, Int64})
precompile(Tuple{getfield(Main, Symbol("#13#14")){String, Bool}, Array{Any, 1}})
precompile(Tuple{typeof(Base.collect_to!), Array{DataFrames.DataFrame, 1}, Base.Generator{Base.Iterators.PartitionIterator{Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(Main, Symbol("#9#10")), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(-)), Tuple{Array{Dates.Date, 1}, Base.RefValue{Dates.Date}}}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, getfield(Main, Symbol("#9#10")), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(-)), Tuple{Array{Dates.Date, 1}, Base.RefValue{Dates.Date}}}}}})
precompile(Tuple{typeof(Base.throw_boundserror), Base.Broadcast.Broadcasted{Nothing, Tuple{Base.OneTo{Int64}}, getfield(Main, Symbol("#9#10")), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(-)), Tuple{Base.Broadcast.Extruded{Array{Dates.Date, 1}, Tuple{Bool}, Tuple{Int64}}, Base.RefValue{Dates.Date}}}}}, Tuple{Int64}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, getfield(Main, Symbol("#9#10")), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(-)), Tuple{Array{Dates.Date, 1}, Base.RefValue{Dates.Date}}}}}})
...
precompile(Tuple{getfield(Main, Symbol("#5#6")){typeof(Statistics.mean), Array{Float64, 1}, Int64}, Int64})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Float64, 1}, Float64, Base.Generator{Base.OneTo{Int64}, getfield(Main, Symbol("#5#6")){typeof(Statistics.mean), Array{Float64, 1}, Int64}}, Int64})
...
precompile(Tuple{Type{NamedTuple{(:xaxis_title, :yaxis_title, :xaxis, :yaxis_ticksuffix, :hovermode, :title, :height, :yaxis_type), T} where T<:Tuple}, Tuple{String, String, Base.Dict{Symbol, Array{Float64, 1}}, String, String, String, String, String}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, String, Base.Dict{Symbol, Array{Float64, 1}}, String, String, String, String, String}}})
precompile(Tuple{getfield(PlotlyBase, Symbol("#_#6#8")), Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:xaxis_title, :yaxis_title, :xaxis, :yaxis_ticksuffix, :hovermode, :title, :height, :yaxis_type), Tuple{String, String, Base.Dict{Symbol, Array{Float64, 1}}, String, String, String, String, String}}}, Type{PlotlyBase.Layout{Base.Dict{Symbol, Any}}}, Base.Dict{Symbol, Any}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:xaxis_title, :yaxis_title, :xaxis, :yaxis_ticksuffix, :hovermode, :title, :height, :yaxis_type), Tuple{String, String, Base.Dict{Symbol, Array{Float64, 1}}, String, String, String, String, String}}, Type{PlotlyBase.Layout{T} where T<:Base.AbstractDict{Symbol, Any}}})
...
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#13#14")){String, Bool}, Base.Iterators.PartitionIterator{Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.PartitionIterator{Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._array_for), Type{DataFrames.DataFrame}, Base.Iterators.PartitionIterator{Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, Base.HasLength})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.PartitionIterator{Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{DataFrames.DataFrame, 1}, Base.Generator{Base.Iterators.PartitionIterator{Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{String, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}})
...
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(*)), Tuple{Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}}})
precompile(Tuple{typeof(Base.setindex!), Array{Float64, 1}, Base.Missing, Int64})
precompile(Tuple{typeof(Base.throw_boundserror), Base.Broadcast.Broadcasted{Nothing, Tuple{Base.OneTo{Int64}}, typeof(Base.:(*)), Tuple{Base.Broadcast.Extruded{Array{Float64, 1}, Tuple{Bool}, Tuple{Int64}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Base.Broadcast.Extruded{Array{Union{Base.Missing, Int64}, 1}, Tuple{Bool}, Tuple{Int64}}}}}}, Tuple{Int64}})
precompile(Tuple{typeof(Base.Broadcast.materialize!), Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(*)), Tuple{Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}}}})
precompile(Tuple{Type{NamedTuple{(:marker_size, :mode, :marker_line_width, :marker_opacity, :y, :name, :text, :hovertemplate, :x), T} where T<:Tuple}, Tuple{Int64, String, Int64, Float64, Base.SubArray{Float64, 1, Array{Float64, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}})
precompile(Tuple{typeof(Base.isempty), NamedTuple{(:marker_size, :mode, :marker_line_width, :marker_opacity, :y, :name, :text, :hovertemplate, :x), Tuple{Int64, String, Int64, Float64, Base.SubArray{Float64, 1, Array{Float64, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}})
...
precompile(Tuple{typeof(Base.foreach), getfield(PlotlyBase, Symbol("#4#5")){PlotlyBase.GenericTrace{Base.Dict{Symbol, Any}}}, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:marker_size, :mode, :marker_line_width, :marker_opacity, :y, :name, :text, :hovertemplate, :x), Tuple{Int64, String, Int64, Float64, Base.SubArray{Float64, 1, Array{Float64, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:marker_size, :mode, :marker_line_width, :marker_opacity, :y, :name, :text, :hovertemplate, :x), Tuple{Int64, String, Int64, Float64, Base.SubArray{Float64, 1, Array{Float64, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, String})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(Main, Symbol("#13#14")){String, Bool}, Base.Iterators.PartitionIterator{Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.PartitionIterator{Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._array_for), Type{DataFrames.DataFrame}, Base.Iterators.PartitionIterator{Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, Base.HasLength})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.PartitionIterator{Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, Int64})
precompile(Tuple{typeof(Base.collect_to!), Array{DataFrames.DataFrame, 1}, Base.Generator{Base.Iterators.PartitionIterator{Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}, Int64, Int64})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{String, Nothing, String, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(Main, Symbol("#13#14")){String, Bool}}})
