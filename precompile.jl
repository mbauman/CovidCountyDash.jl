...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#11#16")){Int64}, OrderedCollections.OrderedDict{Int64, String}})
precompile(Tuple{typeof(Base.iterate), OrderedCollections.OrderedDict{Int64, String}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#11#16")){Int64}, Base.Pair{Int64, String}})
precompile(Tuple{typeof(Base.empty), Array{Any, 1}, Type{NamedTuple{(:label, :value), Tuple{String, Int64}}}})
precompile(Tuple{typeof(Base.push!), Array{NamedTuple{(:label, :value), Tuple{String, Int64}}, 1}, NamedTuple{(:label, :value), Tuple{String, Int64}}})
precompile(Tuple{typeof(Base.grow_to!), Array{NamedTuple{(:label, :value), Tuple{String, Int64}}, 1}, Base.Iterators.Flatten{Base.Generator{Array{Any, 1}, getfield(CovidCountyDash, Symbol("#12#15"))}}, Tuple{Int64, Base.Generator{OrderedCollections.OrderedDict{Int64, String}, getfield(CovidCountyDash, Symbol("#11#16")){Int64}}, Int64}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Flatten{Base.Generator{Array{Any, 1}, getfield(CovidCountyDash, Symbol("#12#15"))}}, Tuple{Int64, Base.Generator{OrderedCollections.OrderedDict{Int64, String}, getfield(CovidCountyDash, Symbol("#11#16")){Int64}}, Int64}})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.coalesce), Tuple{Array{Float32, 1}, Float32}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Type{T} where T, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Float32, 1}, Float32}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Float32, 1}, Float32}}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Float32, 1}, Float32}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Float32, 1}, Float32}}}}})
...
precompile(Tuple{Type{NamedTuple{(:values, :popvalues, :dates, :location), T} where T<:Tuple}, Tuple{Array{Float32, 1}, Array{Float32, 1}, Array{Dates.Date, 1}, String}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Float32, 1}, Array{Float32, 1}, Array{Dates.Date, 1}, String}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:values, :popvalues, :dates, :location), Tuple{Array{Float32, 1}, Array{Float32, 1}, Array{Dates.Date, 1}, String}}, Type{DataFrames.DataFrame}})
...
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#14#17")), Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#13#18")){Int64}, OrderedCollections.OrderedDict{Int64, String}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#13#18")){Int64}, Base.Pair{Int64, String}})
precompile(Tuple{typeof(Base.grow_to!), Array{NamedTuple{(:label, :value), Tuple{String, Int64}}, 1}, Base.Iterators.Flatten{Base.Generator{Array{Any, 1}, getfield(CovidCountyDash, Symbol("#14#17"))}}, Tuple{Int64, Base.Generator{OrderedCollections.OrderedDict{Int64, String}, getfield(CovidCountyDash, Symbol("#13#18")){Int64}}, Int64}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Flatten{Base.Generator{Array{Any, 1}, getfield(CovidCountyDash, Symbol("#14#17"))}}, Tuple{Int64, Base.Generator{OrderedCollections.OrderedDict{Int64, String}, getfield(CovidCountyDash, Symbol("#13#18")){Int64}}, Int64}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#33#50")), Nothing, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.all), Function, Tuple{Nothing, Nothing, Int64, Nothing, Nothing, Nothing}})
precompile(Tuple{typeof(Base._all), typeof(Base.isnothing), Tuple{Nothing, Nothing, Int64, Nothing, Nothing, Nothing}, Base.Colon})
precompile(Tuple{typeof(Base.getproperty), Dash.CallbackContext, Symbol})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#34#51")), Array{NamedTuple{(:prop_id, :value), T} where T<:Tuple, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{NamedTuple{(:prop_id, :value), T} where T<:Tuple, 1}, getfield(CovidCountyDash, Symbol("#34#51"))}})
precompile(Tuple{typeof(Base._array_for), Type{String}, Array{NamedTuple{(:prop_id, :value), T} where T<:Tuple, 1}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{String, 1}, String, Base.Generator{Array{NamedTuple{(:prop_id, :value), T} where T<:Tuple, 1}, getfield(CovidCountyDash, Symbol("#34#51"))}, Int64})
precompile(Tuple{typeof(Base.get), OrderedCollections.OrderedDict{String, Array{Int64, 1}}, Base.SubString{String}, Dash.NoUpdate})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.coalesce), Tuple{Array{Int64, 1}, Float32}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Type{T} where T, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Int64, 1}, Float32}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Int64, 1}, Float32}}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Int64, 1}, Float32}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Int64, 1}, Float32}}}}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#33#50")), Int64, Vararg{Any, N} where N})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#35#52")), Array{Any, 1}, Int64, Array{Any, 1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#36#53")), Array{NamedTuple{(:prop_id, :value), T} where T<:Tuple, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{NamedTuple{(:prop_id, :value), T} where T<:Tuple, 1}, getfield(CovidCountyDash, Symbol("#36#53"))}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{String, 1}, String, Base.Generator{Array{NamedTuple{(:prop_id, :value), T} where T<:Tuple, 1}, getfield(CovidCountyDash, Symbol("#36#53"))}, Int64})
...
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Array{Union{Base.Missing, Int64}, 1}, Float32})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.coalesce), Tuple{Array{Union{Base.Missing, Int64}, 1}, Float32}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Type{T} where T, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Union{Base.Missing, Int64}, 1}, Float32}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Union{Base.Missing, Int64}, 1}, Float32}}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Union{Base.Missing, Int64}, 1}, Float32}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, Type{Float32}, Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Array{Union{Base.Missing, Int64}, 1}, Float32}}}}})
