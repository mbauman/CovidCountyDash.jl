...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{getfield(PlotlyBase, Symbol("##GenericTrace#257")), Symbol, String, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:x, :y, :customdata, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, String, String}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, DataFrames.DataFrame})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{PlotlyBase.GenericTrace{Base.Dict{Symbol, Any}}, 1}, PlotlyBase.GenericTrace{Base.Dict{Symbol, Any}}, Base.Generator{DataFrames.GroupedDataFrame{DataFrames.DataFrame}, getfield(PlotlyBase, Symbol("#258#259")){Symbol, String, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:x, :y, :customdata, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, String, String}}}}}, Int64})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Array{Float32, 1}, Base.Missing})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(*)), Tuple{Array{Float32, 1}, Base.RefValue{Base.Missing}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(*)), Tuple{Array{Float32, 1}, Base.RefValue{Base.Missing}}}})
precompile(Tuple{Type{NamedTuple{(:values, :popvalues, :dates, :location), T} where T<:Tuple}, Tuple{Array{Float32, 1}, Array{Base.Missing, 1}, Array{Dates.Date, 1}, String}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Float32, 1}, Array{Base.Missing, 1}, Array{Dates.Date, 1}, String}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:values, :popvalues, :dates, :location), Tuple{Array{Float32, 1}, Array{Base.Missing, 1}, Array{Dates.Date, 1}, String}}, Type{DataFrames.DataFrame}})
...
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{Float64, 1}, 1}, Array{Base.Missing, 1}, Int64})
...
precompile(Tuple{typeof(Base.copyto!), Array{Union{Base.Missing, Float64}, 1}, Int64, Array{Float64, 1}})
precompile(Tuple{typeof(Base.allocatedinline), Type{Base.Missing}})
precompile(Tuple{typeof(Base.copyto!), Array{Union{Base.Missing, Float64}, 1}, Int64, Array{Base.Missing, 1}})
precompile(Tuple{typeof(Base.copyto!), Array{Union{Base.Missing, Float64}, 1}, Int64, Array{Float32, 1}})
...
precompile(Tuple{Type{NamedTuple{(:mode, :y, :name, :customdata, :hovertemplate, :x), T} where T<:Tuple}, Tuple{String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:mode, :y, :name, :customdata, :hovertemplate, :x), Tuple{String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, String})
...
precompile(Tuple{Type{NamedTuple{(:mode, :y, :name, :customdata, :hovertemplate, :x), T} where T<:Tuple}, Tuple{String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}})
...
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:mode, :y, :name, :customdata, :hovertemplate, :x), Tuple{String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, String})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Array{Int64, 1}, Base.Missing})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(*)), Tuple{Array{Int64, 1}, Base.RefValue{Base.Missing}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(*)), Tuple{Array{Int64, 1}, Base.RefValue{Base.Missing}}}})
precompile(Tuple{Type{NamedTuple{(:values, :popvalues, :dates, :location), T} where T<:Tuple}, Tuple{Array{Int64, 1}, Array{Base.Missing, 1}, Array{Dates.Date, 1}, String}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Int64, 1}, Array{Base.Missing, 1}, Array{Dates.Date, 1}, String}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:values, :popvalues, :dates, :location), Tuple{Array{Int64, 1}, Array{Base.Missing, 1}, Array{Dates.Date, 1}, String}}, Type{DataFrames.DataFrame}})
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{Float32, 1}, 1}, Array{Int64, 1}, Int64})
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{Float32, 1}, 1}, Array{Base.Missing, 1}, Int64})
...
precompile(Tuple{typeof(Base.allocatedinline), Type{Union{Base.Missing, Float32}}})
precompile(Tuple{typeof(Base.copyto!), Array{Union{Base.Missing, Float32}, 1}, Int64, Array{Float32, 1}})
precompile(Tuple{typeof(Base.copyto!), Array{Union{Base.Missing, Float32}, 1}, Int64, Array{Base.Missing, 1}})
precompile(Tuple{typeof(Base.length), Array{Union{Base.Missing, Float32}, 1}})
precompile(Tuple{typeof(Base.view), Array{Union{Base.Missing, Float32}, 1}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Symbol, Any}, Base.SubArray{Union{Base.Missing, Float32}, 1, Array{Union{Base.Missing, Float32}, 1}, Tuple{Array{Int64, 1}}, false}, Symbol})
precompile(Tuple{Type{NamedTuple{(:mode, :y, :name, :customdata, :hovertemplate, :x), T} where T<:Tuple}, Tuple{String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Union{Base.Missing, Float32}, 1, Array{Union{Base.Missing, Float32}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Union{Base.Missing, Float32}, 1, Array{Union{Base.Missing, Float32}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:mode, :y, :name, :customdata, :hovertemplate, :x), Tuple{String, Base.SubArray{Float32, 1, Array{Float32, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Union{Base.Missing, Float32}, 1, Array{Union{Base.Missing, Float32}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, String})
precompile(Tuple{typeof(Base.setindex!), PlotlyBase.GenericTrace{Base.Dict{Symbol, Any}}, Base.SubArray{Union{Base.Missing, Float32}, 1, Array{Union{Base.Missing, Float32}, 1}, Tuple{Array{Int64, 1}}, false}, Symbol})
precompile(Tuple{typeof(JSON.Writer.show_pair), JSON.Writer.CompactContext{Base.GenericIOBuffer{Array{UInt8, 1}}}, JSON.Serializations.StandardSerialization, Symbol, Base.SubArray{Union{Base.Missing, Float32}, 1, Array{Union{Base.Missing, Float32}, 1}, Tuple{Array{Int64, 1}}, false}})
precompile(Tuple{typeof(Base.max), Int64, Int64})
precompile(Tuple{typeof(Base._similar_for), Array{DataFrames.DataFrame, 1}, Type{Array{Base.Missing, 1}}, Base.Generator{Array{DataFrames.DataFrame, 1}, getfield(DataFrames, Symbol("#128#132")){String}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.allocatedinline), Type{Array{Base.Missing, 1}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{Base.Missing, 1}, 1}, Array{Base.Missing, 1}, Base.Generator{Array{DataFrames.DataFrame, 1}, getfield(DataFrames, Symbol("#128#132")){String}}, Int64})
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{Base.Missing, 1}, 1}, Array{Float32, 1}, Int64})
