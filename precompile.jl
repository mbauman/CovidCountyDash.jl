...
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Array{NamedTuple{(:label, :value), Tuple{String, Int64}}, 1}, Bool}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{typeof(Dash.callback!), getfield(CovidCountyDash, Symbol("#28#40")){DataFrames.DataFrame}, Dash.DashApp, Dash.Dependency{Dash.TraitOutput, String}, Array{Dash.Dependency{Dash.TraitInput, String}, 1}})
...
precompile(Tuple{typeof(CovidCountyDash.counties), Nothing})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#hide_missing_row#35")), Nothing, Nothing})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#31#43")), String})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#32#44")), String})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#26#38")){getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Char}, Nothing, Vararg{Nothing, N} where N})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#28#40")){DataFrames.DataFrame}, String, Vararg{Any, N} where N})
precompile(Tuple{typeof(CovidCountyDash.plotit), DataFrames.DataFrame, String, String, Int64, Array{Any, 1}, Nothing, Vararg{Nothing, N} where N})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#precompute##kw")), NamedTuple{(:type, :roll, :value), Tuple{Symbol, Int64, String}}, typeof(CovidCountyDash.precompute), DataFrames.DataFrame, Nothing, Nothing})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#hide_missing_row#35")), Nothing, Array{Any, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#precompute##kw")), NamedTuple{(:type, :roll, :value), Tuple{Symbol, Int64, String}}, typeof(CovidCountyDash.precompute), DataFrames.DataFrame, Array{Any, 1}, Nothing})
precompile(Tuple{getfield(Base, Symbol("#filter##kw")), NamedTuple{(:view,), Tuple{Bool}}, typeof(Base.filter), Function, DataFrames.DataFrame})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(DataFrames, Symbol("#89#90")){getfield(CovidCountyDash, Symbol("#17#18")){Array{Any, 1}, Nothing}}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame, DataFrames.Index}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, getfield(DataFrames, Symbol("#89#90")){getfield(CovidCountyDash, Symbol("#17#18")){Array{Any, 1}, Nothing}}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame, DataFrames.Index}}}})
...
precompile(Tuple{getfield(DataFrames, Symbol("##sort!#613")), Nothing, Function, Function, Bool, Base.Order.ForwardOrdering, typeof(Base.sort!), DataFrames.DataFrame, Symbol})
precompile(Tuple{Type{Base.Order.Perm{O, V} where V<:(AbstractArray{T, 1} where T) where O<:Base.Order.Ordering}, Base.Order.ForwardOrdering, Array{Dates.Date, 1}})
precompile(Tuple{getfield(Base.Sort, Symbol("#defalg##kw")), NamedTuple{(:alg, :cols), Tuple{Nothing, Symbol}}, typeof(Base.Sort.defalg), DataFrames.DataFrame, Base.Order.Perm{Base.Order.ForwardOrdering, Array{Dates.Date, 1}}})
precompile(Tuple{typeof(Base.Sort.defalg), DataFrames.DataFrame, Type{T} where T, Base.Order.Perm{Base.Order.ForwardOrdering, Array{Dates.Date, 1}}})
precompile(Tuple{typeof(Base.sort!), DataFrames.DataFrame, Base.Sort.MergeSortAlg, Base.Order.Perm{Base.Order.ForwardOrdering, Array{Dates.Date, 1}}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#hide_missing_row#35")), Array{Any, 1}, Array{Any, 1}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#26#38")){getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Char}, Array{Any, 1}, Vararg{Any, N} where N})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(DataFrames, Symbol("#89#90")){getfield(CovidCountyDash, Symbol("#17#18")){Array{Any, 1}, Array{Any, 1}}}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame, DataFrames.Index}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, getfield(DataFrames, Symbol("#89#90")){getfield(CovidCountyDash, Symbol("#17#18")){Array{Any, 1}, Array{Any, 1}}}, Tuple{DataFrames.DataFrameRows{DataFrames.DataFrame, DataFrames.Index}}}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
...
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(*)), Tuple{Array{Int64, 1}, Float64}}})
...
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{Int64, 1}, 1}, Array{Float32, 1}, Int64})
precompile(Tuple{typeof(Base.copyto!), Array{Float32, 1}, Int64, Array{Int64, 1}})
precompile(Tuple{typeof(Base.setindex!), Array{Union{Nothing, Array{Any, 1}}, 1}, Array{Any, 1}, Int64})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#26#38")){getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Char}, Nothing, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{Float32, 1}, 1}, Array{Int64, 1}, Int64})
precompile(Tuple{typeof(Base.setindex_widen_up_to), Array{Array{Float32, 1}, 1}, Array{Float64, 1}, Int64})
...
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#37")), Tuple{Tuple{Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing}}, getfield(CovidCountyDash, Symbol("#20#21")){DataFrames.DataFrame, String, String}}})
