...
precompile(Tuple{getfield(CSV, Symbol("##read#77")), Bool, Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(CSV.read), String, Type{T} where T})
...
precompile(Tuple{typeof(Base.grow_to!), Base.Dict{Symbol, Array{Int64, 1}}, Base.Generator{Base.Iterators.Zip{Tuple{Array{Symbol, 1}, Array{AbstractArray{T, 1} where T, 1}}}, getfield(CSV, Symbol("#25#27"))}, Tuple{Int64, Int64}})
precompile(Tuple{Type{CSV.File{false}}, String, Array{Symbol, 1}, Array{Type, 1}, Int64, Int64, Array{AbstractArray{T, 1} where T, 1}, Base.Dict{Symbol, Array{Int64, 1}}})
...
precompile(Tuple{typeof(Base.any), Function, SentinelArrays.SentinelArray{Int64, 1, Int64, Base.Missing, Array{Int64, 1}}})
precompile(Tuple{getfield(Base, Symbol("##any#636")), Function, typeof(Base.any), Function, SentinelArrays.SentinelArray{Int64, 1, Int64, Base.Missing, Array{Int64, 1}}})
precompile(Tuple{typeof(Base._any), getfield(DataFrames, Symbol("#408#409")), SentinelArrays.SentinelArray{Int64, 1, Int64, Base.Missing, Array{Int64, 1}}, Base.Colon})
precompile(Tuple{typeof(Base.any), Function, Array{Int64, 1}})
precompile(Tuple{getfield(Base, Symbol("##any#636")), Function, typeof(Base.any), Function, Array{Int64, 1}})
precompile(Tuple{typeof(Base._any), getfield(DataFrames, Symbol("#408#409")), Array{Int64, 1}, Base.Colon})
...
precompile(Tuple{typeof(DataFrames.row_group_slots), Tuple{Array{Int64, 1}}, Base.Val{true}, Array{Int64, 1}, Bool, Bool})
...
precompile(Tuple{typeof(DataFrames.update_row_maps!), DataFrames.DataFrame, DataFrames.DataFrame, DataFrames.RowGroupDict{DataFrames.DataFrame}, DataFrames.RowIndexMap, DataFrames.RowIndexMap, DataFrames.RowIndexMap, Nothing, Tuple{Array{Int64, 1}}, Tuple{SentinelArrays.SentinelArray{Int64, 1, Int64, Base.Missing, Array{Int64, 1}}}})
...
precompile(Tuple{getfield(DataFrames, Symbol("#select##kw")), NamedTuple{(:copycols,), Tuple{Bool}}, typeof(DataFrames.select), DataFrames.DataFrame, InvertedIndices.InvertedIndex{Array{Symbol, 1}}})
...
precompile(Tuple{typeof(Base.Iterators.enumerate), DataFrames.DataFrameColumns{DataFrames.DataFrame}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Enumerate{DataFrames.DataFrameColumns{DataFrames.DataFrame}}, Tuple{Int64}})
precompile(Tuple{typeof(Base.similar), Array{Dates.Date, 1}, Int64})
precompile(Tuple{typeof(Base.view), Array{Dates.Date, 1}, Array{Int64, 1}})
precompile(Tuple{typeof(Base.copyto!), Array{Dates.Date, 1}, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}})
precompile(Tuple{typeof(Base.iterate), Base.Iterators.Enumerate{DataFrames.DataFrameColumns{DataFrames.DataFrame}}, Tuple{Int64, Int64}})
precompile(Tuple{typeof(Base.similar), PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Int64})
precompile(Tuple{typeof(Base.similar), PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Type{T} where T, Tuple{Int64}})
...
precompile(Tuple{typeof(Base.similar), SentinelArrays.SentinelArray{Int64, 1, Int64, Base.Missing, Array{Int64, 1}}, Int64})
...
precompile(Tuple{typeof(Base.copyto!), Array{Union{Base.Missing, Int64}, 1}, Base.SubArray{Union{Base.Missing, Int64}, 1, SentinelArrays.SentinelArray{Int64, 1, Int64, Base.Missing, Array{Int64, 1}}, Tuple{Array{Int64, 1}}, false}})
...
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(&)), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(&)), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}}}})
...
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Base.Broadcast.DefaultArrayStyle{1}, Function, Array{Int64, 1}, Tuple{Tuple{Int64, Int64, Int64, Int64, Int64}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.in), Tuple{Array{Int64, 1}, Tuple{Tuple{Int64, Int64, Int64, Int64, Int64}}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{Array{Int64, 1}, Tuple{Tuple{Int64, Int64, Int64, Int64, Int64}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.in), Tuple{Array{Int64, 1}, Tuple{Tuple{Int64, Int64, Int64, Int64, Int64}}}}})
...
precompile(Tuple{typeof(Base.view), PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.BitArray{1}})
precompile(Tuple{typeof(Base.Broadcast.materialize!), Base.SubArray{String, 1, PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Int64, 1}}, false}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{0}, Nothing, typeof(Base.identity), Tuple{Base.RefValue{String}}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Base.BitArray{1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(&)), Tuple{Base.BitArray{1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(&)), Tuple{Base.BitArray{1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.RefValue{String}}}}}})
...
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, NamedTuple{(:display,), Tuple{String}}, Array{NamedTuple{(:label, :value), Tuple{String, String}}, 1}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#9#20")){Array{String, 1}}, Base.UnitRange{Int64}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.UnitRange{Int64}, getfield(CovidCountyDash, Symbol("#9#20")){Array{String, 1}}}})
...
precompile(Tuple{typeof(Base.vcat), DashBase.Component, Array{DashBase.Component, 1}})
...
precompile(Tuple{getfield(DashHtmlComponents, Symbol("#html_table##kw")), NamedTuple{(:style,), Tuple{NamedTuple{(:width,), Tuple{String}}}}, typeof(DashHtmlComponents.html_table), Array{DashBase.Component, 1}})
...
precompile(Tuple{typeof(Dash.callback!), getfield(CovidCountyDash, Symbol("#15#28")){DataFrames.DataFrame}, Dash.DashApp, Dash.Dependency{Dash.TraitOutput, String}, Array{Dash.Dependency{Dash.TraitInput, String}, 1}})
...
precompile(Tuple{typeof(JSON2.write), Array{NamedTuple{(:inputs, :state, :output, :clientside_function), Tuple{Array{NamedTuple{(:id, :property), Tuple{String, String}}, 1}, Array{NamedTuple{(:id, :property), Tuple{String, String}}, 1}, String, Nothing}}, 1}})
...
precompile(Tuple{typeof(Dash._single_element_vect), Nothing})
precompile(Tuple{typeof(Dash.validate_callback_return), Array{NamedTuple{(:id, :property), Tuple{String, String}}, 1}, Array{Nothing, 1}, Symbol})
precompile(Tuple{typeof(Dash._push_to_res!), Base.Dict{String, Any}, Array{Nothing, 1}, Array{NamedTuple{(:id, :property), Tuple{String, String}}, 1}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#11#23")){DataFrames.DataFrame}, Nothing})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#hide_missing_row#22")), Nothing, Nothing})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#18#31")), String})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#19#32")), String})
...
precompile(Tuple{typeof(Dash._item_to_dict!), Base.Dict{String, Any}, NamedTuple{(:id, :property, :value), Tuple{String, String, Nothing}}})
precompile(Tuple{Type{NamedTuple{(:prop_id, :value), T} where T<:Tuple}, Tuple{String, Nothing}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#13#26")){getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Char}, Nothing, Vararg{Nothing, N} where N})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
...
precompile(Tuple{typeof(Base.merge_types), Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, Type{NamedTuple{(:kind,), Tuple{String}}}, Type{NamedTuple{(:x, :y, :text, :group, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, Symbol, String, String}}}})
...
precompile(Tuple{typeof(Base.merge_types), Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, Type{NamedTuple{(:style,), Tuple{PlotlyBase.Style}}}, Type{NamedTuple{(:x, :y, :text, :group, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, Symbol, String, String}}}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#15#28")){DataFrames.DataFrame}, String, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Int64, 1}, Array{Int64, 1}, Array{Dates.Date, 1}, Array{String, 1}}}})
precompile(Tuple{typeof(CovidCountyDash.plotit), DataFrames.DataFrame, String, String, Int64, Nothing, Nothing, Vararg{Nothing, N} where N})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
precompile(Tuple{Type{NamedTuple{(:type, :roll, :popnorm), T} where T<:Tuple}, Tuple{Symbol, Int64, Bool}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#precompute##kw")), NamedTuple{(:type, :roll, :popnorm), Tuple{Symbol, Int64, Bool}}, typeof(CovidCountyDash.precompute), DataFrames.DataFrame, Nothing, Nothing})
...
precompile(Tuple{typeof(Base.Broadcast.restart_copyto_nonleaf!), Array{Union{Nothing, Array{Any, 1}}, 1}, Array{Nothing, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Dash._item_to_dict!), Tuple{Base.RefValue{Base.Dict{String, Any}}, Base.Broadcast.Extruded{Array{Any, 1}, Tuple{Bool}, Tuple{Int64}}}}, Array{Any, 1}, Int64, Base.OneTo{Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.Broadcast.restart_copyto_nonleaf!), Array{Union{Nothing, Array{Any, 1}}, 1}, Array{Nothing, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Dash.input_to_arg), Tuple{Base.Broadcast.Extruded{Array{Any, 1}, Tuple{Bool}, Tuple{Int64}}}}, Array{Any, 1}, Int64, Base.OneTo{Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.vcat), Array{Union{Nothing, Array{Any, 1}}, 1}, Array{Any, 1}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#hide_missing_row#22")), Nothing, Array{Any, 1}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#11#23")){DataFrames.DataFrame}, Array{Any, 1}})
precompile(Tuple{typeof(Base.getindex), PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Base.BitArray{1}})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#4#5")), Array{String, 1}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Array{String, 1}, getfield(CovidCountyDash, Symbol("#4#5"))}})
precompile(Tuple{typeof(CovidCountyDash.plotit), DataFrames.DataFrame, String, String, Int64, Nothing, Array{Any, 1}, Vararg{Any, N} where N})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#precompute##kw")), NamedTuple{(:type, :roll, :popnorm), Tuple{Symbol, Int64, Bool}}, typeof(CovidCountyDash.precompute), DataFrames.DataFrame, Array{Any, 1}, Nothing})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Base.Broadcast.DefaultArrayStyle{1}, Function, PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}})
precompile(Tuple{typeof(Base.similar), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.in), Tuple{Base.Broadcast.Extruded{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Bool}, Tuple{Int64}}, Tuple{Array{Any, 1}}}}, Type{Bool}})
precompile(Tuple{typeof(Base.Broadcast.copyto_nonleaf!), Base.BitArray{1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.in), Tuple{Base.Broadcast.Extruded{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Bool}, Tuple{Int64}}, Tuple{Array{Any, 1}}}}, Base.OneTo{Int64}, Int64, Int64})
...
precompile(Tuple{typeof(Base.ntuple), getfield(DataFrames, Symbol("#271#272")){DataFrames.DataFrame}, Int64})
precompile(Tuple{typeof(DataFrames.row_group_slots), Tuple{Array{Dates.Date, 1}}, Base.Val{false}, Array{Int64, 1}, Bool, Bool})
precompile(Tuple{getfield(DataFrames, Symbol("#combine##kw")), NamedTuple{(:renamecols,), Tuple{Bool}}, typeof(DataFrames.combine), DataFrames.GroupedDataFrame{DataFrames.DataFrame}, Base.Pair{Symbol, typeof(Base.sum)}, Base.Pair{Symbol, typeof(Base.sum)}, Vararg{Base.Pair{Symbol, typeof(Base.sum)}, N} where N})
precompile(Tuple{getfield(DataFrames, Symbol("##combine#509")), Bool, Bool, Bool, typeof(DataFrames.combine), DataFrames.GroupedDataFrame{DataFrames.DataFrame}, Base.Pair{Symbol, typeof(Base.sum)}, Vararg{Base.Pair{Symbol, typeof(Base.sum)}, N} where N})
precompile(Tuple{getfield(DataFrames, Symbol("#_combine_prepare##kw")), NamedTuple{(:keepkeys, :ungroup, :copycols, :keeprows, :renamecols), Tuple{Bool, Bool, Bool, Bool, Bool}}, typeof(DataFrames._combine_prepare), DataFrames.GroupedDataFrame{DataFrames.DataFrame}, Base.Pair{Symbol, typeof(Base.sum)}, Vararg{Base.Pair{Symbol, typeof(Base.sum)}, N} where N})
precompile(Tuple{getfield(DataFrames, Symbol("##_combine_prepare#473")), Bool, Bool, Bool, Bool, Bool, typeof(DataFrames._combine_prepare), DataFrames.GroupedDataFrame{DataFrames.DataFrame}, Union{Base.Regex, AbstractString, Function, Signed, Symbol, Unsigned, Base.Pair{A, B} where B where A, AbstractArray{T, 1} where T, Type, DataAPI.All{T} where T<:Tuple, DataAPI.Between{T1, T2} where T2<:Union{Int64, Symbol} where T1<:Union{Int64, Symbol}, DataAPI.Cols{T} where T<:Tuple, InvertedIndices.InvertedIndex{S} where S}, Vararg{Union{Base.Regex, AbstractString, Function, Signed, Symbol, Unsigned, Base.Pair{A, B} where B where A, AbstractArray{T, 1} where T, Type, DataAPI.All{T} where T<:Tuple, DataAPI.Between{T1, T2} where T2<:Union{Int64, Symbol} where T1<:Union{Int64, Symbol}, DataAPI.Cols{T} where T<:Tuple, InvertedIndices.InvertedIndex{S} where S}, N} where N})
...
precompile(Tuple{typeof(Base._any), getfield(DataFrames, Symbol("#499#503")){DataFrames.GroupedDataFrame{DataFrames.DataFrame}}, Array{Any, 1}, Base.Colon})
precompile(Tuple{getfield(DataFrames, Symbol("#499#503")){DataFrames.GroupedDataFrame{DataFrames.DataFrame}}, Base.Pair{Int64, Base.Pair{typeof(Base.sum), Symbol}}})
precompile(Tuple{typeof(DataFrames.fillfirst!), Nothing, Array{Int64, 1}, Base.UnitRange{Int64}, DataFrames.GroupedDataFrame{DataFrames.DataFrame}})
precompile(Tuple{typeof(DataFrames._combine_process_agg), Base.Pair{Int64, #s151} where #s151<:(Base.Pair{#s150, Symbol} where #s150<:Function), Bool, DataFrames.DataFrame, DataFrames.GroupedDataFrame{DataFrames.DataFrame}, Base.Dict{Symbol, Tuple{Bool, Int64}}, Array{DataFrames.TransformationResult, 1}, Array{Int64, 1}})
...
precompile(Tuple{Type{DataFrames.TransformationResult}, Array{Int64, 1}, Array{Union{Base.Missing, Int64}, 1}, Symbol, Bool})
precompile(Tuple{getfield(DataFrames, Symbol("#502#506")){Array{AbstractArray{T, 1} where T, 1}}, Array{Int64, 1}})
precompile(Tuple{getfield(DataFrames, Symbol("#502#506")){Array{AbstractArray{T, 1} where T, 1}}, Array{Union{Base.Missing, Int64}, 1}})
...
precompile(Tuple{getfield(Base, Symbol("##sprint#355")), Nothing, Int64, typeof(Base.sprint), Function, Array{Any, 1}, Vararg{Any, N} where N})
...
precompile(Tuple{Type{NamedTuple{(:values, :dates, :diff, :location), T} where T<:Tuple}, Tuple{Array{Float64, 1}, Array{Dates.Date, 1}, Array{Union{Base.Missing, Float64}, 1}, String}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Float64, 1}, Array{Dates.Date, 1}, Array{Union{Base.Missing, Float64}, 1}, String}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:values, :dates, :diff, :location), Tuple{Array{Float64, 1}, Array{Dates.Date, 1}, Array{Union{Base.Missing, Float64}, 1}, String}}, Type{DataFrames.DataFrame}})
...
precompile(Tuple{typeof(Base._similar_for), Array{DataFrames.DataFrame, 1}, Type{Array{Union{Base.Missing, Float64}, 1}}, Base.Generator{Array{DataFrames.DataFrame, 1}, getfield(DataFrames, Symbol("#128#132")){String}}, Base.HasShape{1}})
precompile(Tuple{typeof(Base.allocatedinline), Type{Array{Union{Base.Missing, Float64}, 1}}})
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Array{Union{Base.Missing, Float64}, 1}, 1}, Array{Union{Base.Missing, Float64}, 1}, Base.Generator{Array{DataFrames.DataFrame, 1}, getfield(DataFrames, Symbol("#128#132")){String}}, Int64})
...
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:x, :y, :text, :group, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, Symbol, String, String}}, Type{PlotlyBase.Plot{TT, TL, TF} where TF<:(AbstractArray{#s21, 1} where #s21<:(PlotlyBase.PlotlyFrame{T} where T<:Base.AbstractDict{Symbol, Any})) where TL<:PlotlyBase.AbstractLayout where TT<:(AbstractArray{#s51, 1} where #s51<:PlotlyBase.AbstractTrace)}, DataFrames.DataFrame, PlotlyBase.Layout{Base.Dict{Symbol, Any}}})
precompile(Tuple{getfield(PlotlyBase, Symbol("##GenericTrace#257")), Symbol, String, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:x, :y, :text, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, String, String}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, DataFrames.DataFrame})
...
precompile(Tuple{typeof(Base.merge_types), Tuple{Symbol, Symbol, Symbol, Symbol, Symbol, Symbol, Symbol}, Type{NamedTuple{(:kind, :name), Tuple{String, String}}}, Type{NamedTuple{(:x, :y, :text, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, String, String}}}})
precompile(Tuple{typeof(Base.merge), NamedTuple{(:kind, :name), Tuple{String, String}}, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:x, :y, :text, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, String, String}}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Symbol, Symbol, Symbol, String, String}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:kind, :name, :x, :y, :text, :hovertemplate, :mode), Tuple{String, String, Symbol, Symbol, Symbol, String, String}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, DataFrames.SubDataFrame{DataFrames.DataFrame, DataFrames.Index, Array{Int64, 1}}})
...
precompile(Tuple{Type{NamedTuple{(:mode, :y, :name, :text, :hovertemplate, :x), T} where T<:Tuple}, Tuple{String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:mode, :y, :name, :text, :hovertemplate, :x), Tuple{String, Base.SubArray{Union{Base.Missing, Float64}, 1, Array{Union{Base.Missing, Float64}, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, String})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{PlotlyBase.GenericTrace{Base.Dict{Symbol, Any}}, 1}, PlotlyBase.GenericTrace{Base.Dict{Symbol, Any}}, Base.Generator{DataFrames.GroupedDataFrame{DataFrames.DataFrame}, getfield(PlotlyBase, Symbol("#258#259")){Symbol, String, Base.Iterators.Pairs{Symbol, Any, Tuple{Symbol, Symbol, Symbol, Symbol, Symbol}, NamedTuple{(:x, :y, :text, :hovertemplate, :mode), Tuple{Symbol, Symbol, Symbol, String, String}}}}}, Int64})
...
precompile(Tuple{typeof(CovidCountyDash.plotit), DataFrames.DataFrame, String, String, Int64, Array{Any, 1}, Array{Any, 1}, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Int64, Array{Union{Base.Missing, Int64}, 1}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}, Float64})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}, Float64}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}, Float64}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(*)), Tuple{Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}, Float64}}}})
precompile(Tuple{typeof(Base.Broadcast.materialize!), Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(*)), Tuple{Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Union{Base.Missing, Int64}, 1}}}, Float64}}}}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#hide_missing_row#22")), Array{Any, 1}, Array{Any, 1}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
precompile(Tuple{typeof(Base.setindex!), Array{Union{Nothing, Array{Any, 1}}, 1}, Nothing, Int64})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#13#26")){getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Char}, Nothing, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Nothing, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.endswith), String, Char})
precompile(Tuple{typeof(Base.similar), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.endswith), Tuple{Base.Broadcast.Extruded{Array{Any, 1}, Tuple{Bool}, Tuple{Int64}}, Base.Broadcast.Extruded{Array{Char, 0}, Tuple{}, Tuple{}}}}, Type{Bool}})
precompile(Tuple{typeof(Base.Broadcast.copyto_nonleaf!), Base.BitArray{1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.endswith), Tuple{Base.Broadcast.Extruded{Array{Any, 1}, Tuple{Bool}, Tuple{Int64}}, Base.Broadcast.Extruded{Array{Char, 0}, Tuple{}, Tuple{}}}}, Base.OneTo{Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.any), Base.BitArray{1}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
precompile(Tuple{getfield(CovidCountyDash, Symbol("#precompute##kw")), NamedTuple{(:type, :roll, :popnorm), Tuple{Symbol, Int64, Bool}}, typeof(CovidCountyDash.precompute), DataFrames.DataFrame, Array{Any, 1}, Array{Any, 1}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Base.Broadcast.DefaultArrayStyle{1}, Function, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(&)), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(&)), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Array{Any, 1}}}}}}})
precompile(Tuple{typeof(Base.similar), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.:(&)), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{Base.Broadcast.Extruded{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Bool}, Tuple{Int64}}, Tuple{Array{Any, 1}}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{Base.Broadcast.Extruded{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Bool}, Tuple{Int64}}, Tuple{Array{Any, 1}}}}}}, Type{Bool}})
precompile(Tuple{typeof(Base.Broadcast.copyto_nonleaf!), Base.BitArray{1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(Base.:(&)), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{Base.Broadcast.Extruded{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Bool}, Tuple{Int64}}, Tuple{Array{Any, 1}}}}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.in), Tuple{Base.Broadcast.Extruded{PooledArrays.PooledArray{String, UInt32, 1, Array{UInt32, 1}}, Tuple{Bool}, Tuple{Int64}}, Tuple{Array{Any, 1}}}}}}, Base.OneTo{Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.:(*)), String, String, String})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
precompile(Tuple{typeof(Base.setindex!), Array{Union{Nothing, Array{Any, 1}}, 1}, Array{Any, 1}, Int64})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Nothing, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
...
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Int64, 1}}}, Float64})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Int64, 1}}}, Float64}})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Int64, 1}}}, Float64}}})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(Base.:(*)), Tuple{Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Int64, 1}}}, Float64}}}})
precompile(Tuple{typeof(Base.Broadcast.materialize!), Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(*)), Tuple{Array{Float64, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.coalesce), Tuple{Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(/)), Tuple{Int64, Array{Int64, 1}}}, Float64}}}}})
...
precompile(Tuple{Type{NamedTuple{(:mode, :y, :name, :text, :hovertemplate, :x), T} where T<:Tuple}, Tuple{String, Base.SubArray{Float64, 1, Array{Float64, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{String, Base.SubArray{Float64, 1, Array{Float64, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}})
precompile(Tuple{getfield(Core, Symbol("#Type##kw")), NamedTuple{(:mode, :y, :name, :text, :hovertemplate, :x), Tuple{String, Base.SubArray{Float64, 1, Array{Float64, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{String, 1, Array{String, 1}, Tuple{Array{Int64, 1}}, false}, String, Base.SubArray{Dates.Date, 1, Array{Dates.Date, 1}, Tuple{Array{Int64, 1}}, false}}}, Type{PlotlyBase.GenericTrace{T} where T<:Base.AbstractDict{Symbol, Any}}, String})
...
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Nothing, Nothing, Nothing, Array{Any, 1}, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Nothing, Array{Any, 1}, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Nothing, Array{Any, 1}, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Nothing, Nothing, Nothing, Array{Any, 1}, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.Iterators.partition), Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}, Int64})
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base._compute_eltype), Type{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}}})
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
...
precompile(Tuple{getfield(CovidCountyDash, Symbol("#13#26")){getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Char}, Array{Any, 1}, Vararg{Any, N} where N})
precompile(Tuple{typeof(Base.Broadcast.broadcasted), Function, Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Char})
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Axes, F, Args} where Args<:Tuple where F where Axes}, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}})
precompile(Tuple{typeof(Base.Broadcast.instantiate), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
precompile(Tuple{typeof(Base.copy), Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple}, Nothing, getfield(CovidCountyDash, Symbol("#contains_footnote#25")), Tuple{Tuple{Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}, Array{Char, 0}}}})
...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}, Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}})
...
precompile(Tuple{typeof(Base.collect), Base.Generator{Base.Iterators.PartitionIterator{Tuple{Array{Any, 1}, Array{Any, 1}, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Array{Any, 1}, Nothing, Nothing, Nothing, Nothing, Nothing}}, getfield(CovidCountyDash, Symbol("#6#7")){DataFrames.DataFrame, String, Bool}}})
